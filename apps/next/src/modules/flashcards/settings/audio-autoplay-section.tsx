 ...
 * Zustand store in use-autoplay-term-audio.ts, so it applies immediately to
 * any currently-mounted card without a page reload, and resets to enabled
 * on next load (not persisted - per-session as requested).
 */
